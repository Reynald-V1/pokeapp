    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `pokemon` (`id` INTEGER NOT NULL, `name` TEXT NOT NULL, `altura` INTEGER NOT NULL, `peso` INTEGER NOT NULL, `imageUrl` TEXT NOT NULL, `vidaBase` TEXT NOT NULL, PRIMARY KEY (`id`))');
  ...
  Future<List<Pokemon>> findAllPokemons() async {
    return _queryAdapter.queryList('SELECT * FROM pokemon',
        mapper: (Map<String, Object?> row) => Pokemon(
            ...
            vidaBase: row['vidaBase'] as String));
  }
